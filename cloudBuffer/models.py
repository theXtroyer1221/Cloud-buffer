...
class User(db.Model, UserMixin):
    ...
    groupposts = db.relationship("Grouppost",
                                 backref="group_author",
                                 lazy=True)
    comments = db.relationship("Comment", backref="author", lazy=True)
    groupcomments = db.relationship("Groupcomment",
                                    backref="author",
                                    lazy=True)
